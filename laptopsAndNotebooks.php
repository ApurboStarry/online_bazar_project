...
<html lang="en" dir="ltr">
  ...
  <body>
    <?php
        ...
        $result = pg_query($conn, "select product_id, product_name, description, stock_quantity, price, discount, average_rating, no_of_reviews, company_name, colour, warranty, photo, hdd, ssd, processor_type, cpu_speed, operating_system, graphics_card, ram from laptop_and_desktop_view where category_id = 3");
        if (!$result) {
        ...
        echo "<br>";
        echo "<br>";
        echo "<h1>Laptops And Notebooks</h1>";
        echo "<br>";
        echo "<br>";
    ...
    <div class="filter">
        <form action="http://localhost:4000/www/filteredLaptopsAndNotebooks.php" method="post">
            <p>Filter By Brand</p>
            ...
            <p>Filter By Storage Capacity(in TB)</p>
            <input type="radio" name="rom" value=1>1
            <input type="radio" name="rom" value=2>2
