...
<head>
    ...
    <title>Update Laptop or Desktop</title>
</head>
<body>
    <br>
    ...
    <form action="#" method="post">
        ...
        <input type="radio" name="entity" value="hdd">HDD <br>
        <input type="radio" name="entity" value="ssd">SSD <br>
        <input type="radio" name="entity" value="processor_type">Photo <br>
        <input type="radio" name="entity" value="cpu_speed">CPU Speed <br>
        <input type="radio" name="entity" value="operating_system">Operating System <br>
        <input type="radio" name="entity" value="graphics_card">Graphics Card <br>
    ...
    <?php
        if(isset($_POST['submit']) and isset($_POST['updateValue'])) {
            ...
            if($entity == "product_name" or $entity == "description" or $entity == "stock_quantity" or $entity == "price" or $entity == "discount" or $entity == "company_name" or $entity == "colour" or $entity == "warranty" or $entity == "photo") {
                ...
                if(gettype($updatedValue) == 'integer'){
                    $result = pg_query($conn, "update laptop_and_desktop set $entity=$updatedValue where product_id = $product_id");
                    if (!$result) {
                    echo "An error occurred.\n";
                    exit;
                    }
