...
<html lang="en" dir="ltr">
  ...
  <body>
    <?php
        ...
        $result = pg_query($conn, "select  product_id, product_name, description, stock_quantity, price, discount, average_rating, no_of_reviews, company_name, colour, warranty, photo, ram, rom, processor_type, os, gpu from mobile_tablet_view where category_id = 2");
        if (!$result) {
    ...
    <div class="filter">
        <form action="http://localhost:4000/www/filteredTablets.php" method="post">
            <p>Filter By Brand</p>
